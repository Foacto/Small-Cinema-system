 ...
 * 
 */
@WebServiceClient(name = "UserWS", targetNamespace = "http://ws.test.htc.com/", wsdlLocation = "http://localhost:8080/ServerKTTKPM/UserWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWS_QNAME = new QName("http://ws.test.htc.com/", "UserWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServerKTTKPM/UserWS?wsdl");
    ...
    public UserWS getUserWSPort() {
        return super.getPort(new QName("http://ws.test.htc.com/", "UserWSPort"), UserWS.class);
    }
    ...
    public UserWS getUserWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.test.htc.com/", "UserWSPort"), UserWS.class, features);
    }
